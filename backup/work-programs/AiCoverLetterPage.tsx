...
export default function AiCoverLetterPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8 animate-fade-in">
      <Link to="/work" className="inline-flex items-center gap-2 text-dc-text-secondary mb-6 text-lg font-bold">
        <ArrowLeft size={24} />
        <span>일터</span>
      </Link>
      ...
      {!result ? (
        ...
        <div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <Link to="/work" className="btn-primary w-full text-xl">일터로 돌아가기</Link>
          </div>
        </div>
      )}
    </div>
